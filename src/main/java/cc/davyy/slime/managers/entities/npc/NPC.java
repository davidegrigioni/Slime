package cc.davyy.slime.managers.entities.npc;
...
import static cc.davyy.slime.managers.entities.npc.NPCManager.JOINING_INSTANCE_TAG;
...
public class NPC extends EntityCreature {
    ...
    public void setName(String name) {
        this.name = "[NPC] " + name;
        entityMeta.setCustomName(of(this.name)
                .parseLegacy()
                .build()); // make sure to update visually in-game when this method is called
    }
