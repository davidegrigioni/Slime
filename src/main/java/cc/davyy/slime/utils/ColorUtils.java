...
public final class ColorUtils {
    ...
    public @NotNull ColorUtils addComponentPlaceholder(@Subst("test_pl") @NotNull String placeholder, @NotNull ComponentLike value) {
        minimessagePlaceholders.add(Placeholder.component(placeholder, value));
        return this;
    }

    public @NotNull ColorUtils addFormattedStringPlaceholder(@Subst("test_pl") @NotNull String placeholder, @NotNull String value) {
        minimessagePlaceholders.add(Placeholder.component(placeholder, of(value).parseLegacy().build()));
        return this;
    }

    public @NotNull ColorUtils addPlainStringPlaceholder(@Subst("test_pl") @NotNull String placeholder, @NotNull String value) {
        minimessagePlaceholders.add(Placeholder.unparsed(placeholder, value));
        return this;
    }
